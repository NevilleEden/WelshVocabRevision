...
const WORDS = [
  ...
  { cy: "taeru", en: "to insist, to swear blind", type: "verb", note: "asserts a claim is true; contrast mynnu" },
  { cy: "mynnu", en: "to insist on doing/having; to demand", type: "verb", note: "takes an action; taeru takes a claim" },
  { cy: "rhywsut rywfodd", en: "somehow or other", type: "adv" },
  { cy: "nes", en: "until (an event happens)", type: "prep", note: "nes i'r trên gyrraedd; tan = up to a point in time" },

  // Grammar patterns (present in Geirfa_Bersonol.md, added for parity)
  { cy: "cael + ei/eu + berfenw", en: "the standard Welsh passive", type: "pattern", note: "cael eu colli = being lost" },
  { cy: "i + rhagenw + berfenw", en: "that X did Y / after X did Y", type: "pattern", note: "iddi gael ei dylanwadu; wedi iddo ddod yn Brif Weinidog" },
  { cy: "[ans.] o [ans.]", en: "intensifier: first adjective boosts the second", type: "pattern", note: "allweddol o bwysig = crucially important" },
  { cy: "pa mor [ans.] oedd...", en: "embedded 'how [adjective] was...'", type: "pattern", note: "pa mor uchel oedd safle rhywun" },
  { cy: "y... yn ei [berfenw]", en: "resumptive-pronoun relative clause", type: "pattern", note: "needed when bydd/byddai + yn can't take a + soft mutation" },

  // Uwch 2 — Uned 15 (Y Border Bach) — the gwr-/gwy- cluster
  { cy: "gwraidd", en: "root (as a whole/mass); figurative origin", type: "noun", g: "m", note: "pl. gwreiddiau; gwraidd y broblem. gwreiddyn = one individual root (singulative). Compounds built on gwraidd" },
  { cy: "gwreiddlysiau", en: "root vegetables", type: "noun", note: "gwraidd + llysiau; plural only" },
  { cy: "gwreiddiol", en: "original, initial", type: "adj", note: "from gwraidd — not from gwyrth" },
  { cy: "gwyrth", en: "a miracle", type: "noun", g: "f", note: "pl. gwyrthiau" },
  { cy: "gwyrthiol", en: "miraculous, wondrous", type: "adj", note: "from gwyrth, NOT gwraidd — the four-way trap with gwreiddyn/gwreiddiol/gwreiddlysiau" },
  { cy: "gardd", en: "garden", type: "noun", g: "f", note: "pl. gerddi. Contrast cerdd (poem) — both give y g- after the article" },
  { cy: "cerdd", en: "a poem", type: "noun", g: "f", note: "pl. cerddi. Family: cerddor, cerddoriaeth. NOT cerddwr (a walker)" },

  // Uwch 2 — Uned 15 (Garddio) — transferable words from the unit's geirfa
  { cy: "maetholyn", en: "a nutrient", type: "noun", g: "m", note: "pl. maetholion" },
  { cy: "cymysgedd", en: "a mixture", type: "noun", g: "m", note: "pl. cymysgeddau" },
  { cy: "pla", en: "a pest; a plague", type: "noun", g: "m", note: "pl. plâu; one letter from ffa (beans)" },
  { cy: "chwynnyn", en: "one weed", type: "noun", g: "m", note: "pl. chwyn (collective); chwynnu = to weed" },
  { cy: "nionyn", en: "onion (gogledd)", type: "noun", g: "m", note: "pl. nionod; southern wynwnsyn/wynwns" },
  { cy: "atal", en: "to prevent, to stop, to halt", type: "verb", note: "transitive alone: atal hunanladdiad. Add rhag only for preventing a PERSON from an ACTION: atal rhywun rhag gadael" },
  { cy: "cylchdroi", en: "to rotate", type: "verb", note: "cylchdro = a rotation, a cycle" },
  { cy: "blodeuo", en: "to blossom, to flower", type: "verb", note: "also figurative — a career, a friendship" },
  { cy: "chwynnu", en: "to weed", type: "verb", note: "double n" },
  { cy: "torri'n fân", en: "to chop finely", type: "idiom" },
  { cy: "amgen", en: "alternative", type: "adj", note: "meddyginiaeth amgen, ynni amgen" },
  { cy: "lluosflwydd", en: "perennial", type: "adj" },
  { cy: "golygus", en: "handsome, good-looking", type: "adj" },
  { cy: "cymwynas", en: "a favour, a kindness, a good turn", type: "noun", g: "f", note: "pl. cymwynasau; gwneud cymwynas â rhywun" },
  { cy: "cymwynasgar", en: "helpful, obliging", type: "adj", note: "someone who actually does things for others — warmer and more specific than caredig" },
  { cy: "gafael (yn)", en: "to grip, to hold", type: "verb", note: "takes yn + treiglad meddal; the sustained holding; commoner in the north than cydio" },
  { cy: "cydio (yn)", en: "to grip, to seize; to catch on, take root", type: "verb", note: "mae'r tân wedi cydio. The moment of taking hold; more frequent in writing" },
  { cy: "gafaelgar", en: "gripping, compelling", type: "adj", note: "of a book, film, speech. gafael + -gar" },
  { cy: "cael gafael ar", en: "to get hold of, to obtain", type: "idiom" },
  { cy: "mynd ati", en: "to set about (doing) something", type: "idiom", note: "neutral; bwrw ati = with energy; dal ati = keep at it" },
  { cy: "bwrw ati", en: "to set to, to get stuck in", type: "idiom", note: "takes i + berfenw for the task" },
  { cy: "edrych ymlaen at", en: "to look forward to", type: "idiom", note: "at + berfenw takes a soft mutation: edrych ymlaen at weld" },
  { cy: "yn sgil", en: "in the wake of, as a result of", type: "idiom", note: "formal/news register; needs a genuine causal chain, not mere sequence" },
  { cy: "enw + enw (y genidol)", en: "possessive 'of' — just juxtapose the nouns", type: "pattern", note: "no preposition, no mutation: cost tanwydd, costau byw, dyfodol barddoni. Article on the 2nd noun only: nifer y banciau bwyd. Use o ONLY for partitive 'some of': nifer o bobl" },
  { cy: "llwyth", en: "1) a tribe 2) a load, a burden", type: "noun", g: "m", note: "plural tells them apart: llwythau = tribes, llwythi = loads. Gives llwytho, dadlwytho" },
  { cy: "lledu", en: "to spread (by widening outwards)", type: "verb", note: "from lled/llydan. lledu neges, lledu'r gair. No surface needed — contrast taenu" },
  { cy: "ymledu", en: "to spread of its own accord", type: "verb", note: "no agent: mae'r clefyd yn ymledu" },
  { cy: "taenu", en: "to spread (a substance over a surface)", type: "verb", note: "taenu menyn ar y bara. Figurative: taenu si (spread a rumour). NOT taeru (to insist)" },

  // Golwg360 — "Yr Wyddfa a'r Fenai" (over-tourism opinion piece)
  { cy: "dyfyniad", en: "a quotation", type: "noun", g: "m", note: "pl. dyfyniadau" },
  { cy: "stranc", en: "a strop, a tantrum", type: "noun", g: "f", note: "pl. strancau; cael stranc = to throw a strop" },
  { cy: "bro", en: "a region, a home area/locality", type: "noun", g: "f", note: "pl. bröydd" },
  { cy: "llu", en: "a host, a multitude", type: "noun", g: "m", note: "pl. lluoedd" },
  { cy: "anhrefn", en: "chaos, disorder", type: "noun", g: "f", note: "an- + trefn" },
  { cy: "perchennog", en: "an owner", type: "noun", g: "m", note: "pl. perchenogion" },
  { cy: "cyflog", en: "wage, salary", type: "noun", g: "m", note: "pl. cyflogau — gender unverified, some sources give f too" },
  { cy: "tâl", en: "pay, payment", type: "noun", g: "m" },
  { cy: "enillion", en: "earnings", type: "noun", note: "plural only, from ennill" },
  { cy: "swydd", en: "a job, a post", type: "noun", g: "f", note: "pl. swyddi" },
  { cy: "cyflogaeth", en: "employment", type: "noun", g: "f" },
  { cy: "cyflogwr", en: "an employer", type: "noun", g: "m", note: "pl. cyflogwyr" },
  { cy: "diffeithwch", en: "a wasteland, a desert", type: "noun", g: "m" },
  { cy: "coloni", en: "a colony", type: "noun", g: "m", note: "pl. colonïau" },
  { cy: "cyrchfan", en: "a destination, a resort", type: "noun", g: "f", note: "pl. cyrchfannau; gender unverified. The place, not the tourists" },
  { cy: "tynged", en: "fate, destiny", type: "noun", g: "f" },
  { cy: "gorchwyl", en: "a task, a labour", type: "noun", g: "m", note: "pl. gorchwylion; etymology of -chwyl part unverified" },
  { cy: "heddwch", en: "peace", type: "noun", g: "m" },
  { cy: "prysurdeb", en: "busyness", type: "noun", g: "m", note: "prysur + -deb" },
  { cy: "grwgnach", en: "to grumble", type: "verb" },
  { cy: "myllio", en: "to fume, to lose one's temper", type: "verb", note: "colloquial, strongly Gogledd" },
  { cy: "cyflwyno", en: "to present, to convey", type: "verb", note: "impers. past cyflëwyd" },
  { cy: "cafwyd", en: "there was/were had", type: "verb", note: "impersonal past of cael" },
  { cy: "dylid", en: "one ought to / it should [be done]", type: "verb", note: "impersonal of dylu" },
  { cy: "gwingo", en: "to writhe, to squirm; to strain/buckle", type: "verb" },
  { cy: "ailadrodd", en: "to repeat", type: "verb" },
  { cy: "edliw", en: "to begrudge, to reproach (someone) for", type: "verb" },
  { cy: "britho", en: "to speckle, to dapple, to dot", type: "verb" },
  { cy: "portreadu", en: "to portray", type: "verb", note: "impers. past portreadwyd" },
  { cy: "cydnabod", en: "to recognise, to acknowledge", type: "verb", note: "impers. cydnabyddir" },
  { cy: "troedio", en: "to tread, to walk (on)", type: "verb" },
  { cy: "gwynfanllyd", en: "whingey, given to complaining", type: "adj" },
  { cy: "argoelus", en: "ominous, foreboding", type: "adj", note: "from argoel" },
  { cy: "ffyniannus", en: "thriving, prosperous", type: "adj" },
  { cy: "heddychlon", en: "peaceful", type: "adj" },
  { cy: "methiannus", en: "failing, faulty", type: "adj", note: "from methu" },
  { cy: "anghynaladwy", en: "unsustainable", type: "adj", note: "from cynnal" },
  { cy: "gwirioneddol", en: "genuine, true, real", type: "adj" },
  { cy: "helaeth", en: "extensive, considerable", type: "adj" },
  { cy: "cron", en: "round", type: "adj", note: "feminine form of crwn" },
  { cy: "dethol", en: "select, chosen", type: "adj", note: "as adj, often elite/exclusive connotation; also a verb, to select" },
  { cy: "cyflogedig", en: "employed / an employee", type: "adj" },
  { cy: "hunangyflogedig", en: "self-employed", type: "adj" },
  { cy: "cael cam", en: "to be wronged, treated unfairly", type: "idiom" },
  { cy: "taro ar (rywun)", en: "to occur to (someone)", type: "idiom" },
  { cy: "crafu bywoliaeth", en: "to scrape a living", type: "idiom" },
  { cy: "boed...neu...", en: "be it...or.../whether...or...", type: "idiom", note: "LITERARY ONLY — not spoken. Literary 3rd-pers. imperative of bod" },
  { cy: "naill ai...neu...", en: "either...or...", type: "idiom", note: "the everyday spoken equivalent of boed...neu..." },
  { cy: "gor-", en: "over-/excessive- (prefix)", type: "pattern", note: "verified cognate with English over-" },
  { cy: "holl-", en: "all-/entirely- (prefix)", type: "pattern" },
  { cy: "di-", en: "un-/without- (negating prefix)", type: "pattern" },
];
